...
import 'package:petroplus/repositories/recommedations_repostitory.dart';
...
class FinalizeBudgetBloc extends Bloc<FinalizeBugetEvent, FinalizeBugetState> {
  final RecommedationsRepository recommedationsRepository;
  ...
  FutureOr<void> _onFinalizeBugetStarted(
    ...
    try {
      var recommedations = await recommedationsRepository.recommendations();
